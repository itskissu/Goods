...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='https://telegram.me/kissuXbots')
            ]]
            ...
            return
        buttons = [[
                    InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='https://telegram.me/pwlived'),
                    InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇꜱ', url='https://telegram.me/kissuXbots')
                 ]]
        reply_markup=InlineKeyboardMarkup(buttons)
            ...
            for u in message.new_chat_members:
                ...
                temp.MELCOW['welcome'] = await message.reply_photo(
                                                 ...
                                                 reply_markup=InlineKeyboardMarkup(
                                                                         [[
                                                                           InlineKeyboardButton('ᴘʀᴇᴍɪᴜᴍ', url='https://t.me/xaekks'),
                                                                           InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇꜱ', url='https://telegram.me/kissuXbots')
                                                                        ]]
                                                 ),
